...
class GechoServiceController {
  final int timerSecond = 20;
   final StreamController<IResponseModel<List<MainCurrencyModel>>>
      _streamControllerForUsdCoins =
      StreamController<IResponseModel<List<MainCurrencyModel>>>.broadcast();
   final StreamController<IResponseModel<List<MainCurrencyModel>>>
      _streamControllerForTryCoins =
      StreamController<IResponseModel<List<MainCurrencyModel>>>.broadcast();
   final StreamController<IResponseModel<List<MainCurrencyModel>>>
      _streamControllerForEthCoins =
      StreamController<IResponseModel<List<MainCurrencyModel>>>.broadcast();
   final StreamController<IResponseModel<List<MainCurrencyModel>>>
      _streamControllerForBtcCoins =
      StreamController<IResponseModel<List<MainCurrencyModel>>>.broadcast();
   final StreamController<IResponseModel<List<MainCurrencyModel>>>
      _streamControllerForNewCoins =
      StreamController<IResponseModel<List<MainCurrencyModel>>>.broadcast();

  Stream<IResponseModel<List<MainCurrencyModel>>> get streamUsd =>
      _streamControllerForUsdCoins.stream;

  Stream<IResponseModel<List<MainCurrencyModel>>> get streamTry =>
      _streamControllerForTryCoins.stream;

  Stream<IResponseModel<List<MainCurrencyModel>>> get streamEth =>
      _streamControllerForEthCoins.stream;
  Stream<IResponseModel<List<MainCurrencyModel>>> get streamBtc =>
      _streamControllerForBtcCoins.stream;
  Stream<IResponseModel<List<MainCurrencyModel>>> get streamNew =>
      _streamControllerForNewCoins.stream;
  ...
  Future<void> fetchNewGechoUsdCoinListManual() async {
  ...
  Future<void> fetchDataTransactionForUsd() async {
    ...
    if (responseUSD.error != null) {
      ...
      _streamControllerForUsdCoins.sink.add(responseUSD);
  ...
  Future<void> fetchNewGechoUsdCoinListTransactionForUsd() async {
    ...
    if (coinsToBeAdded.isNotEmpty) {
      ...
      if (responseNEW.error != null) {
        ...
        _streamControllerForNewCoins.sink.add(responseNEW);
  ...
  Future<void> fetchDataTransactionForTry() async {
    ...
    if (responseTRY.error != null) {
      ...
      _streamControllerForTryCoins.sink.add(responseTRY);
  ...
  Future<void> fetchDataTransactionForBtc() async {
    ...
    if (responseBTC.error != null) {
      ...
      _streamControllerForBtcCoins.sink.add(responseBTC);
  ...
  Future<void> fetchDataTransactionForEth() async {
    ...
    if (responseETH.error != null) {
      ...
      _streamControllerForEthCoins.sink.add(responseETH);
